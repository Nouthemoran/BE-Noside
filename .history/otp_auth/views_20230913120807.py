...
from otp_auth.serializers import UserSerializer, SendOTPSerializer, VerifyOTPSerializer, ChangePasswordSerializer, AccTokenRefreshSerializer
...
class SendOTPView(GenericAPIView):
    ...
    def post(self, request):
        ...
        # Kirim otp ke user
        from_email = 'pt keberlanjutan strategis indonesia', settings.EMAIL_HOST_USER
