...
from ot.serializers import UserSerializer, SendOTPSerializer, VerifyOTPSerializer, ChangePasswordSerializer, AccTokenRefreshSerializer

from ot.models import OTP
